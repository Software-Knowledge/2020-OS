...
| ![](img/lec3/81.png) | ![](img/lec3/15.png) |
| -------------------- | -------------------- |
...
### 6.7.2. 多级页表地址转换过程
| ![](img/lec3/71.png) | ![](img/lec3/72.png) |
| -------------------- | -------------------- |
| ![](img/lec3/73.png) | ![](img/lec3/74.png) |
...
### 6.8.5. 反置页表的地址转换
| ![](img/lec3/75.png) | ![](img/lec3/76.png) |
| -------------------- | -------------------- |
...
| 线性反置页表         | 反置页表                   |
| -------------------- | -------------------------- |
| ![](img/lec3/77.png) | ![](img/lec3/78.png)       |
...
## 7.5. 段式存储管理的地址转换流程
| ![](img/lec3/28.png) | ![](img/lec3/85.png) |
| -------------------- | -------------------- |
...
# 8. 分页和分段的寻址计算
| ![](img/lec3/37.png) | ![](img/lec3/38.png) |
| -------------------- | -------------------- |
...
## 8.2. 分页:逻辑地址到物理地址
| ![](img/lec3/65.png) | ![](img/lec3/66.png) |
| -------------------- | -------------------- |
| ![](img/lec3/67.png) | ![](img/lec3/68.png) |
| ![](img/lec3/69.png) |                      |
...
| ![](img/lec3/47.png) | ![](img/lec3/48.png) |
| -------------------- | -------------------- |
...
| ![](img/lec3/45.png) | ![](img/lec3/46.png) |
| -------------------- | -------------------- |
...
## 13.2. 段页式虚拟存储管理的地址转换
| ![](img/lec3/33.png) | ![](img/lec3/88.png) |
| -------------------- | -------------------- |
...
| ![](img/lec3/61.png) | ![](img/lec3/62.png) |
| -------------------- | -------------------- |
